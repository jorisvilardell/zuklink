//! # ZukLink Yellowpage
//!
//! Cluster coordination library for distributed streaming using Chitchat (Quickwit's Gossip Protocol).
//!
//! This library provides:
//! - Peer discovery via Scuttlebutt/Gossip Protocol
//! - Failure detection with Phi Accrual
//! - Synchronized cluster view for consistent hashing
//! - Key-Value store for node metadata
//!
//! ## Architecture
//!
//! ZukLink Yellowpage wraps [Chitchat](https://github.com/quickwit-oss/chitchat) to provide
//! a simplified API for cluster coordination in the ZukLink streaming platform.
//!
//! ## Example
//!
//! ```rust,no_run
...
//!     ).await?;
//!
//!     // Mark this node as a receiver
//!     yellowpage.set_metadata("role", "receiver").await;
//!
//!     // Get sorted list of live nodes for consistent hashing
